...
document = Document.new(title: 'Certificat Urbanisme', category: "Urbanisme", user: romain, created_at: 210.days.ago)
...
document = Document.new(title: 'Ouverture Chantier', category: "Urbanisme", user: romain, created_at: 210.days.ago)
document.photo.attach(io: open('seed_images/documents/ouverture_chantier.jpg'), filename: 'document.jpg', content_type: 'image/jpg')
document.save!
puts "--- Et d'un autre !"

document = Document.new(title: 'Ouverture EDF', category: "Contrats", user: romain, created_at: 210.days.ago)
document.photo.attach(io: open('seed_images/documents/ouverture_edf.jpg'), filename: 'document.jpg', content_type: 'image/jpg')
document.save!
puts "--- Et d'un autre !"

document = Document.new(title: 'Ouverture eau', category: "Contrats", user: romain, created_at: 210.days.ago)
document.photo.attach(io: open('seed_images/documents/ouverture_eau.png'), filename: 'document.png', content_type: 'image/png')
document.save!
puts "--- Et d'un autre !"

document = Document.new(title: 'Contrat gaz', category: "Contrats", user: romain, created_at: 150.days.ago)
...
Tutorial.create!(title:"Les types de chauffages", description:"Nous vous présentons l'installation de différents type de chauffage, chauffe-eau et radiateur adapté à la maison neuve, respectant la RT2012.", url:"www.youtube.com/watch?v=KuSKdDKQCQU#t=0m23s")
...
Task.create!(created_at: 6.days.ago, title: "Domotique entrée", content: "Installation de votre portier. Tout marche parfaitement, vous allez pouvoir faire de beaux portraits de vos invités ;-)", seen: true, job: etape)
...
Task.create!(created_at: 12.days.ago, title: "Eclairage extérieur", content: "On termine la pose de vos éclairages au sol dans le jardin et sur la terrasse.", seen: true, job: etape)
